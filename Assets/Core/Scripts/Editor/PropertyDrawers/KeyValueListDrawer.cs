...
using SwyTapp.Core.Editor.Extensions;
using SwyTapp.Core.Editor.Utils;
...
namespace SwyTapp.Core.Editor.PropertyDrawers
{
    ...
    public class KeyValueListDrawer : PropertyDrawer
    {
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            {
                SerializedProperty keysProperty = property.FindPropertyRelative("_serializedKeys");
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                SerializedProperty keysProperty = property.FindPropertyRelative("_serializedKeys");
                SerializedProperty valuesProperty = property.FindPropertyRelative("_serializedValues");
